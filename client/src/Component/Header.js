...
const kakaoLogin = () => { //카카오로그인
  ...
  `https://kauth.kakao.com/oauth/authorize?client_id=0f8bff12e99bf62cf63de306e104978b&redirect_uri=https://oh-jeju.link/OAuth/kakao&state=${state}&response_type=code`;
...
const googleLogin = () => { //구글로그인
  ...
  `https://accounts.google.com/o/oauth2/v2/auth?client_id=933835778992-s0h1t6030sssr4qqhi9tdu0kj95nnu5i.apps.googleusercontent.com&response_type=token&redirect_uri=https://oh-jeju.link/OAuth/google&scope=https://www.googleapis.com/auth/userinfo.email`
