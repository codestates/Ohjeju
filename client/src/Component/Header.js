...
const kakaoLogin = () => { //카카오로그인
  ...
  // || '0f8bff12e99bf62cf63de306e104978b'
  //여기 process.env는 제대로 안받아와진다 서버는 되는데; 서버쪽에 client_secret이 있으니 상관없을까
  // const REDIRECT_URI =  "http://localhost:3000/OAuth/kakao";
  const REDIRECT_URI =  "https://oh-jeju.ml/OAuth/kakao"; 
...
const googleLogin = () => { //구글로그인
  ...
  // || '933835778992-s0h1t6030sssr4qqhi9tdu0kj95nnu5i.apps.googleusercontent.com'
